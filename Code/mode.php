...
$pdoStat = $objetPdo->prepare('UPDATE education SET provinces=:provinces, garcon=:garcon, fille=:fille WHERE id =:num LIMIT 1');
$pdoStat->bindValue(':num', $_POST['num'], PDO::PARAM_INT);
$pdoStat->bindValue(':provinces', $_POST['provinces'], PDO::PARAM_STR);
$pdoStat->bindValue(':garcon', $_POST['garcon'], PDO::PARAM_STR);
$pdoStat->bindValue(':fille', $_POST['fille'], PDO::PARAM_STR);
