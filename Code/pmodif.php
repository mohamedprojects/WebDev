...
$pdoStat = $objetPdo->prepare('SELECT * FROM population WHERE provinces= :provinces');
$pdoStat->bindValue(':provinces', $_GET['provinces'], PDO::PARAM_STR);
...
<div class="row">
  ...
  <div class="main">
	...
	Provinces et préfectures :   <input type="text" name="provinces" value="<?php $population['provinces']; ?>"  >      Population :   <input type="number" name="population" value="<?php $population['population']; ?>"> <br> <input type="submit" value="Enregistrer" class="fakeimg">
	</form>
