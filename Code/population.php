...
<div class="row">
  ...
  <div class="main">
	...
	Provinces et préfectures :   <input type="text" name="provinces">        Population :   <input type="number" name="population" >  <br> <input type="submit" value="Envoyer" class="fakeimg">
	</form>
	<form action="modif.php" method="post"> <input type="submit" value="modifier" class="fakeimg1"></form>
